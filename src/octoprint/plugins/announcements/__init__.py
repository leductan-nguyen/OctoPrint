...
__copyright__ = "Copyright (C) 2016 The RaionPi Project - Released under terms of the AGPLv3 License"
...
class AnnouncementPlugin(octoprint.plugin.AssetPlugin,
	...
	def get_settings_defaults(self):
		'''
		return dict(channels=dict(_important=dict(name="Important RaionPi Announcements",
		                                          priority=1,
		                                          type="rss",
		                                          url="http://octoprint.org/feeds/important.xml",
		                                          read_until=1449446400),
		                          _releases=dict(name="RaionPi Release Announcements",
		                                         priority=2,
		                                         type="rss",
		                                         url="http://octoprint.org/feeds/releases.xml"),
		                          _spotlight=dict(name="RaionPi Community Spotlights",
		                                          priority=2,
		                                          type="rss",
